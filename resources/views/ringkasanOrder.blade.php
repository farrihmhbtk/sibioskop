            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12 mb-5">
                            <div class="wrapper" style="position: relative; width: 480px; ">
                                <img id="video-cover-0" src="{{ $film->linkCoverTrailer }}" alt="Video title"
                                    style="max-width: 100%; height:auto; border-radius: 8px; border: 2px solid black; box-shadow: -10px 12px black">
                                <iframe id="video-0" width="480" height="269"
                                ...
                                <button id="playbutton-0" class="play-btn">
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-8" style="">
                                    <ul class="text-start"
                                        style="list-style-type: none; font-family: 'Poppins', sans-serif; ">
                                        <li class=""
                ...
                <div class="col-sm-6" style=" font-family: 'Poppins', sans-serif; margin-left: 50%;">
                    <div class="row">
                        ...
                        @php
                            $lastOrder = DB::table('pesanans')
                                ->join('jadwal_films', 'pesanans.showID', '=', 'jadwal_films.showID')
                                ->select('pesanans.*')
                                ->where('pesanans.showID', '=', $showID)
                                ->latest('pesanans.orderNumber')
                                ->first();
                        ...
                        <h4 class="fw-bold">NOMOR ORDER: {{ $newOrderNumber }}</h4>
                        ...
                        <ul style="list-style-type: none;">
                            ...
                            @php
                                $jadwals = DB::table('jadwal_films')
                                    ...
                                    ->select('jadwal_films.*', 'tanggal_tayangs.*', 'waktu_tayangs.*', 'cinemas.cinema')
                            ...
                            @foreach ($jadwals as $jadwal)
                                <li>
                                    <span>{{ $jadwal->cinema }}</span>, Studio {{ $jadwal->studioID }}
                                </li>
                                <li>
                                    <span>{{ $jadwal->showDate }}</span>, {{ $jadwal->startTime }}
                                </li>
                            ...
                            <li>
                                <span class="fw-bold">{{ $length }} TIKET</span> &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;{{ $seats }}
                            </li>
                            <li>
                                <span class="fw-bold">Kursi</span>&emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;Rp{{ $jadwal->price }},- x {{ $length }}
                            </li>
                            <li>
                                <span class="fw-bold">Biaya layanan</span> &emsp; &emsp; &emsp; &emsp;Rp5.000,- x {{ $length }}
                            </li>

                            <li style="color: red;">
                                * Pembelian tiket tidak dapat dirubah/dibatalkan
                            </li>
                            <li style="color: red">
                            ...
                            $multiply = $length;
                            $biayaLayanan = 5000;
                            $totBay = ($price * $multiply) + ($biayaLayanan * $multiply);
                        @endphp
                        <li class=" fs-6" style="">
                            TOTAL BAYAR<span class="fw-bold">&emsp; &emsp; &emsp; &nbsp; &nbsp;Rp{{ $totBay }}</span>
                        </li>
                        
                            @endforeach
                        </ul>
                        <div class="d-flex" style="padding-left: 0;">
                            <a href="/transfer/{{ $showID }}/{{ $seats }}/{{ $totBay }}/{{ $newOrderNumber }}" style="text-decoration: none; color: black; z-index: 100;">
