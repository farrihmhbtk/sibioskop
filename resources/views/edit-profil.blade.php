        ...
        ">
            ...
            <form action="">
                <input type="text" name="text" class="form-control"
                            id="text" placeholder="Nama" autofocus required value="{{ old('email') }}">
                ...
                <input type="text" name="text" class="form-control"
                            id="text" placeholder="Email" autofocus required value="{{ old('email') }}">
                <label for="nama" style="font-family: 'Poppins', sans-serif;"></label>

                <input type="text" name="text" class="form-control"
                            id="text" placeholder="Password" autofocus required value="{{ old('email') }}">
                <label for="nama" style="font-family: 'Poppins', sans-serif;"></label>
            </form>
