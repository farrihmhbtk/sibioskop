...
@section('container')
    ...
    <div class="d-flex mb-4" style="border-box-shadow: 1px solid black; box-shadow: -8px 10px #EEC921; width:97%; background-color: white; font-family: 'Poppins', sans-serif; border: 2px solid black; border-radius: 5px; justify-content: center; padding-top: 4rem">

        <div class="mx-3 my-4" style="list-style-type: none; display: flex; flex-direction: column;">
            
            <div style="position: relative; left:15%">
                @foreach ($films as $film)
                <div class="me-4" style="top: 50%; width: 700px; float: none; display: flex; flex-direction: column; justify-content: center; align-items: center; z-index:2; position: absolute;">
                    <div style="position: relative">
                        <div class="wrapper" style="width: 700px; justify-content: center; justify-content: center; align-items: center; position:relative;">
                            <button id="playbutton" class="play-btn" style="top: 0; left: 0; right: 0; bottom: 0;  transform: none; ">
            ...
            <div class="d-flex bottom-content-start mb-4" style="width:60rem; height: 40rem; background-color: #EEC921; font-family: 'Poppins', sans-serif; border: 2px solid black; border-radius: 5px; position: relative; margin-top: 10%; z-index: 1; margin-top: 13rem">
                <div style="margin-top: 15rem; padding-left: 3rem; padding-right: 3rem;">
                    <div style="display: flex;">
                        ...
                        <div style="display: flex; flex-direction: column; width: 30rem; margin-left: 1rem;">
                            <p style="font-weight: bold">Antman : Quantumania</p>
                            <p>Detail Transaksi</p>
                            <div style="display: flex; gap: 2rem;">
                                <div style="display: flex; flex-direction: column;">
                                    <p style="font-weight: bold">2 Tiket</p>
                        ...
                        <div style="display: flex; margin-left: 10rem">
                            <img src="image/Group 66.png" alt="Hilang" style="width: 90%; height: 70%;">
                        </div>
