                    ...
                    <div class="me-4"
                        ...
                        <div style="position: relative">
                            <div class="wrapper"
                                ...
                                <iframe id="video-0" width="700" height="390"
                ...
                <div style="margin-top: 15rem; padding-left: 3rem; padding-right: 3rem;">
                    <div style="display: flex;">
                        <div class="col-sm-12 d-flex align-items-start"
                            ...
                            @foreach ($films as $film)
                                <div class="wrapper"
                                    style="width: 160px; float: none; display:inline-block;position: relative; margin-right:30px; padding-left: 7%;">
                        ...
                        @foreach ($jadwals as $jadwal)
                            <div style="display: flex; flex-direction: column; width: 30rem; margin-left: 1rem; width: 100%;">
